...
public class CombineClass {
    ...
    CombineClass(Button clear_button, Button add_button, TextView change_text, AssetManager assetManager,
                 String modelPath, String labelPath, int inputSize, String classification_model,
                 int classification_inputsize) throws IOException{
