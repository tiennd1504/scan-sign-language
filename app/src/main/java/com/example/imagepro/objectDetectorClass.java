...
public class  objectDetectorClass {
    ...
    private Interpreter interpreter; //hand
    private Interpreter interpreter2;//SL
    ...
    objectDetectorClass(AssetManager assetManager,String modelPath, String labelPath,int inputSize,
                        String classification_model,int classification_inputsize) throws IOException{
    ...
    public Mat recognizeImage(Mat mat_image){
        ...
        for (int i=0;i<10;i++){
            ...
            if(score_value>0.5){
                ...
                Bitmap scaledBitmap1 = Bitmap.createScaledBitmap(bitmap1,Classification_Input_Size,
                        Classification_Input_Size,false);
                ...
                Imgproc.putText(rotated_mat_image,""+sign_val,new Point(x1+10,y1+40),2,
                        1.5,new Scalar(255, 255, 255, 255),2);
